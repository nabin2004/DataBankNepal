      ...
      <div className='flex flex-row justify-between w-[75%] p-4 '>
        <div className='flex flex-col gap-5 overflow-auto scroll-smooth' style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          ...
          <div>
            ...
            <p className='text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum harum accusantium sed accusamus non distinctio, debitis numquam, vel dolorum illo dolorem itaque odio aut laudantium. Eius dignissimos ut eos doloremque enim minima qui nesciunt! Autem inventore repudiandae odit nesciunt sapiente!</p>
          </div>
          ...
          <div>
            ...
            <p className='text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam praesentium ex modi ipsa assumenda sunt eligendi dignissimos atque, iure obcaecati cumque placeat mollitia in sapiente esse nostrum officia id vitae.</p>
          </div>
        </div>
      </div>
  );
