...
export default function LeftPanel() {
  ...
  <div className='flex font-inter  shadow-md '>
            ...
            <ul>
              ...
              <li>
                <Link to="/download">
                  <div className="">
                    <button className="flex gap-2 hover:bg-[#A41034] p-4 rounded-lg w-full hover:text-white">
                      <div className='material-symbols-outlined mr-2'>download_for_offline</div>Download
                    </button>
                  </div>
                </Link>
              </li>
                ...
                <Link to="/contact" >
                  ...
                  <div className="">
                    <button className="flex gap-2 mt-2 hover:bg-[#A41034] p-4 rounded-lg w-full hover:text-white">
                      <div className='material-symbols-outlined flex mr-2'>report</div>Contact
                    </button>
                  </div>
                </Link>
                <Link to="/about" >
                  ...
                  <div className="border-b">
              <button className="flex gap-2 mt-2 hover:bg-[#A41034] p-4 rounded-lg w-full hover:text-white">
                <div className='material-symbols-outlined flex mr-2'>info</div>About
              </button>
            </div>
            </Link>
              </li>
        ...
        <div className=' w-[100%]'>
          ...
          <div id='box2render' className='flex flex-col h-screen gap-2 overflow-auto scroll-smooth' style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }} >
            <Routes>
